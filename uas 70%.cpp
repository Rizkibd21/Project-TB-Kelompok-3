...
void drawCloud(float x, float y, float z)
{
    ...
    drawSphere(x, y, z, 1.5f);
    drawSphere(x + 1.0f, y, z, 1.0f);
    drawSphere(x - 1.0f, y, z, 1.0f);
    drawSphere(x, y + 0.5f, z, 1.0f);
}
...
void display()
{
    ...
    // Draw cloud
    drawCloud(-6.5f, 5.0f, -10.0f); // Tinggi awan diatur menjadi 10.0f
    drawCloud(-2.4f, 10.5f, -10.0f);
    drawCloud(2.3f, 8.0f, -10.0f);
    glFlush();
    glutSwapBuffers();
}
...
void pohon()
{
    ...
    glColor3d(0.0, 0.8, 0.0);
    glTranslated(-20.0, 2.0, 0.0);
    glutWireSphere(1.01, 15, 15);
    glColor3d(0.0, 0.5, 0.0);
    glutSolidSphere(1.0, 21, 21);
